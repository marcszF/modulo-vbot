...
if type(storage.moneyItems) ~= "table" then
  storage.moneyItems = {3031, 3035, 55500}
end
...
macro(60000, "Enviar mensagem no Trade", function()
...
UI.TextEdit(storage.autoTradeMessage or "Eu amo MOT", function(widget, text)
