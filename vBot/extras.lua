...
UI.Button("Scripts Extras", function()
  extrasWindow:show()
  extrasWindow:raise()
  extrasWindow:focus()
end)
...
addItem("rope", "Corda Item", 7884, leftPanel,
  "Este item sera usado em varios scripts relacionados a bots como item de corda padrao.")
addItem("shovel", "Shovel Item", 7883, leftPanel,
  "Este item sera usado em varios scripts relacionados a bots como pa padrao.")
addItem("machete", "Machete Item", 9596, leftPanel,
  "Este item sera usado em varios scripts relacionados a bots como item padrao de facao.")
addItem("scythe", "Scythe Item", 9596, leftPanel,
  "This item will be used in various bot related scripts as default scythe item.")
addCheckBox("pathfinding", "Navegacao do Cavebot", true, leftPanel,
  "O Cavebot buscara automaticamente o primeiro ponto de referencia alcancavel apos errar 10 comandos.")
...
addCheckBox("timers", "MW & WG Timers", true, rightPanel, "Horarios das apresentações de MW e Wild Growths.")
if true then
  local activeTimers = {}
...
addCheckBox("autoOpenDoors", "Auto Open Doors", true, rightPanel, "Abra as portas ao tentar pisar nelas.")
if true then
...
addCheckBox("bless", "Comprar Bless ao logar", true, rightPanel, "Diz !bless no login.")
if true then
  local blessed = false
  onTextMessage(function(mode, text)
    ...
    if text == "Voce ja tem todas as blesses!" then
      blessed = true
    end
  end)
